import Set10_Wordgame
##reload(Set10_Wordgame)
from Set10_Wordgame import *
...
def testComputerPlayer():
    ...
    """
    wordlist = Wordlist()
    p = ComputerPlayer(1, {'c':1, 'a':1, 'b':1 ,'d':1, 'o':1, 'e':1})
    testResult(getWordScore(p.pickBestWord()) == getWordScore('abode'))
